...
main = tkinter.Tk()
main.title("A deep learning based experiment on a forest wildfire detection in a machine vision course") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='A deep learning based experiment on a forest wildfire detection in a machine vision course')
